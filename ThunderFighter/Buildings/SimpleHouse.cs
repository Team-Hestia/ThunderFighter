namespace ThunderFighter.Buildings
{
    ...
    internal class SimpleHouse : Building, IBulletShooter
    {
        ...
        private static List<List<Pixel>> BodyStates()
        {
            ...
            strongBody.Add(new Pixel(2, -2, '\\', ConsoleColor.Black));
            strongBody.Add(new Pixel(2, -3, '_', ConsoleColor.Black));
            strongBody.Add(new Pixel(3, 0, '|', ConsoleColor.Black));
            strongBody.Add(new Pixel(3, -1, '\\', ConsoleColor.Black));
          //strongBody.Add(new Pixel(3, -2, '-', ConsoleColor.Black));
            strongBody.Add(new Pixel(3, -3, '_', ConsoleColor.Black));
            strongBody.Add(new Pixel(4, -1, '_', ConsoleColor.Black));
          //strongBody.Add(new Pixel(4, -2, '_', ConsoleColor.Black));
            strongBody.Add(new Pixel(4, -3, '_', ConsoleColor.Black));
            strongBody.Add(new Pixel(5, 0, '[', ConsoleColor.Black));
            strongBody.Add(new Pixel(5, -1, '_', ConsoleColor.Black));
            strongBody.Add(new Pixel(5, -3, 'I', ConsoleColor.Black));
            strongBody.Add(new Pixel(6, 0, ']', ConsoleColor.Black));
            strongBody.Add(new Pixel(6, -1, '_', ConsoleColor.Black));
          //strongBody.Add(new Pixel(6, -2, '-', ConsoleColor.Black));
            strongBody.Add(new Pixel(6, -3, '_', ConsoleColor.Black));
            strongBody.Add(new Pixel(7, -1, '_', ConsoleColor.Black));
            strongBody.Add(new Pixel(7, -2, '\\', ConsoleColor.Black));
            strongBody.Add(new Pixel(8, 0, '|', ConsoleColor.Black));
            strongBody.Add(new Pixel(8, -1, '\\', ConsoleColor.Black));
